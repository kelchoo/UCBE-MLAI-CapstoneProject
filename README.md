...
#### In addition, its important to note that out of the lowest rated app developers, the majority have international origins based on their foreign language names and non LLC, and non U.S. related incorporation of their name and head office status as shown above in the chart of the lowest rated developers. 

Therefore, this finding shows Shopify needs to implement some additional banking security measures and questionaires as well as credit worthiness checks for foreign apps to evaluate the credibility of their sign up and country origin to prevent future fraud and scamming of sellers and buyers accounts from happeninig.
This will help reduce the fraud related compensation to customers and establish Shopify as a trust brand for partners and end customers alike.
